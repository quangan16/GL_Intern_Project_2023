...
public:
	Cube();
	Cube(Vector2 _position, double _rotation,int _direction, double _velocity);
	Cube(Vector2 _position, double _rotation, int _direction, double _velocity, std::shared_ptr<TextureManager> _texture, SDL_RendererFlip _flip, int _width, int _height);
	~Cube();
