...
void GSPlay::Update(float deltaTime)
{
	...
	int speed = 1000.0f * deltaTime;
	m_player->SetPlayerPosition(m_player->GetPlayerPosition().x + speed, m_player->GetPlayerPosition().y);
	button->Set2DPosition(Camera::GetInstance()->GetPosition().x + SCREEN_HEIGHT, 10);
	if (isJumping == true) {
